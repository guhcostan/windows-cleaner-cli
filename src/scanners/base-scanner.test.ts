...
describe('BaseScanner', () => {
  ...
  beforeEach(async () => {
    testDir = await mkdtemp(join(tmpdir(), 'windows-cleaner-scanner-test-'));
  ...
  describe('createResult', () => {
    it('should create result with correct structure', async () => {
      scanner.testItems = [
        { path: 'C:\\test\\path', size: 100, name: 'test', isDirectory: false },
      ];
    ...
    it('should calculate total size correctly', async () => {
      scanner.testItems = [
        { path: 'C:\\test\\path1', size: 100, name: 'test1', isDirectory: false },
        { path: 'C:\\test\\path2', size: 200, name: 'test2', isDirectory: false },
        { path: 'C:\\test\\path3', size: 300, name: 'test3', isDirectory: false },
      ];
